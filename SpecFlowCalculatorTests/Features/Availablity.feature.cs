...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("12", "1", "13", null)]
        [NUnit.Framework.TestCaseAttribute("34", "12", "46", null)]
        [NUnit.Framework.TestCaseAttribute("100", "101", "201", null)]
        public void CalculatingMTBF(string mTTF, string mTTR, string result, string[] exampleTags)
        {
...
#line hidden
#line 9
        testRunner.Then(string.Format("the availability result should be {0}", result), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
        ...
        [NUnit.Framework.CategoryAttribute("Availability")]
        [NUnit.Framework.TestCaseAttribute("200", "210", "0.95", null)]
        [NUnit.Framework.TestCaseAttribute("45", "60", "0.75", null)]
        [NUnit.Framework.TestCaseAttribute("900", "1000", "0.9", null)]
        public void CalculatingAvailability(string mTTF, string mTBF, string result, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "Availability"};
            if ((exampleTags != null))
